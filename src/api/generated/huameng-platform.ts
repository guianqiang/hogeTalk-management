...
export const verificationEnterpriseSchema = z.object({
  ...
  directory_visibility: z.enum(['private', 'listed', 'public']),
  created_at: z.string(),
}).strip()
...
const currentStaffAssignmentSchema = z.object({
  ...
  grants: z.array(z.object({
    ...
    action: z.enum([
      ...
      'content.publish',
      'content.news.manage',
      'content.investment.manage',
      'content.association.manage',
      ...
      'product.curate',
      'product.tour.curate',
      'product.education.curate',
      'product.supply_chain.curate',
      'inquiry.manage',
      'inquiry.export',
      'partner.manage',
      'country.manage',
